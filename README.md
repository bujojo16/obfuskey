...
- directly in your Tails Os, download the "[obfuskey\_executables](https://github.com/bujojo16/obfuskey_executables)" repo and follow the instructions in the README over there (recommended)
...
**The easiest way remains to create a new Tails Os USB stick with the latest version of it and just run the "**[obfuskey\_executables](https://github.com/bujojo16/obfuskey_executables)**".**
