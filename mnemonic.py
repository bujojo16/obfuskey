...
class Mnemonic:
    ...
    default_mnemonic_256hash = "2f5eed53a4727b4bf8880d8f3f199efc90e58503646d9ff8eff3a2ed3b24dbda"
    ...
    def check_hash_of_default_mnemonic():
        return hashlib.sha256(open(Mnemonic.default_mnemonic_path, "rb").read()).hexdigest() == Mnemonic.default_mnemonic_256hash
